...
![Speech Control Blog Cover](system_design/img/speech_control_blog_cover.png)
...
![Speech Control Overall Architecture](system_design/img/overall_architecture_topology_aws.png)
...
graph TD
    ...
    class Agent,RobotLambda ComputeStyle;
    class S3,Cognito,IdentityPool StorageStyle;
    class CF,Gateway,Runtime GatewayStyle;
...
Voice-controlling mechanical joints requires highly responsive, bidirectional audio streaming. Standard HTTP request-response patterns are too slow, introducing multi-second round-trip delays that can cause severe safety issues in hardware operations.
...
![Cognito Authenticator Resources Stack](system_design/img/authenticator_resources_aws.png)
...
![Secure Sign-in and SigV4 Presign Handshake Flow](system_design/img/authenticator_flow_aws.png)
...
![AWS Bedrock AgentCore L2 Sandbox Targets](system_design/img/robot_tool_gateway_sandbox_aws.png)
...
![AWS Bedrock AgentCore Secure Gateway Execution Flow](system_design/img/robot_tool_gateway_flow_aws.png)
